    ...
    <div class="icons right">
      ...
      <div class="sub-menu-wrap" id="showMenu">
        <div class="sub-menu">
            ...
            <a href="" class="sub-menu-link">
              <img src="data:image/png;base64,">
              <p>Switch account</p>
              <span>&#8250;</span>
            </a>

            <a href="" class="sub-menu-link">
              <img src="data:image/png;base64,">              <p>Sign out</p>
              <span></span>
            </a>
            </div>
        </div>
